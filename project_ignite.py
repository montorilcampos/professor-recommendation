...
# Define the columns to calculate aggregate statistics
...
# Aggregate features by professor, also considering course
...
if st.button("Find Best Professor"):
    ...
    professor_name = best_professor.iloc[0]
    prof_keywords = get_top_keywords(professor_name, reviews_df, boost_factor=2)
    # Making prof_keywords a single list of strings
